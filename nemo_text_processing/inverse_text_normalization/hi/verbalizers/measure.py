...
# input_text = 'measure { decimal { integer_part: "१०१"  fractional_part: "००" } units: "kg" }'
# input_text = 'measure { decimal { integer_part: "८६००६"  fractional_part: "७६७" } units: "in³"  }'
# input_text = 'measure { decimal { integer_part: "८६००६" fractional_part: "७६७" } }'
input_text = 'decimal { integer_part: "८६००६" fractional_part: "७६७" }'
output = apply_fst(input_text, measure.decimal)
print(output)
